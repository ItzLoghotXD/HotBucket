...
public final class Bukkit {
    ...
    /**
     * Get the maximum amount of players who can join to this server.
     *
     ...
     * <p>
     * The update folder name is relative to the plugin's folder.
     *
    ...
    /**
     * Gets the radius, in blocks, around each world's spawn point to protect.
     *
    ...
    /**
     * Sets the radius, in blocks, around each world's spawn point to protect.
     *
    ...
    /**
     * Gets an all tags which have been defined within the server.
     * <br>
     * Server implementations are allowed to handle only the registries
     * indicated in {@link Tag}.
     * <br>
