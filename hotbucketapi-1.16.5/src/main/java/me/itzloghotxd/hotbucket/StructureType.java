...
import me.itzloghotxd.hotbucket.map.MapCursor;
...
public final class StructureType {
     ...
     * @param mapIcon the {@link me.itzloghotxd.hotbucket.map.MapCursor.Type} this structure type should use
    ...
    /**
     * Get the {@link me.itzloghotxd.hotbucket.map.MapCursor.Type} that this structure can use on maps. If
     * this is null, this structure will not appear on explorer maps.
     *
     * @return the {@link me.itzloghotxd.hotbucket.map.MapCursor.Type} or null.
     */
    @Nullable
