...
import me.itzloghotxd.hotbucket.projectiles.ProjectileSource;
...
public interface LivingEntity extends Attributable, Damageable, ProjectileSource {
     ...
     * @return block that the living entity has targeted
     * @see #getTargetBlockExact(int, me.itzloghotxd.hotbucket.FluidCollisionMode)
     */
    @Nullable
