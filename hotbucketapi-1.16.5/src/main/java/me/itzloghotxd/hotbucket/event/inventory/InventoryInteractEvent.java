...
public abstract class InventoryInteractEvent extends InventoryEvent implements Cancellable {
     ...
     *
     * @param newResult the new {@link me.itzloghotxd.hotbucket.event.Event.Result} for this event
     * @see #isCancelled()
     */
    ...
    /**
     * Gets the {@link me.itzloghotxd.hotbucket.event.Event.Result} of this event. The Result describes the
    ...
    /**
     * Proxy method to {@link #setResult(me.itzloghotxd.hotbucket.event.Event.Result)} for the Cancellable
     * interface. {@link #setResult(me.itzloghotxd.hotbucket.event.Event.Result)} is preferred, as it allows
