...
public class PlayerBedEnterEvent extends PlayerEvent implements Cancellable {
     ...
     * <p>
     * In case of {@link me.itzloghotxd.hotbucket.event.Event.Result#DEFAULT}, the default outcome is described by
     * {@link #getBedEnterResult()}.
     *
     * @return the action to take with the interacted bed
     * @see #setUseBed(me.itzloghotxd.hotbucket.event.Event.Result)
     */
    @NotNull
     ...
     * <p>
     * {@link me.itzloghotxd.hotbucket.event.Event.Result#ALLOW} will result in the player sleeping, regardless of
     * the default outcome described by {@link #getBedEnterResult()}.
     * <br>
     * {@link me.itzloghotxd.hotbucket.event.Event.Result#DENY} will prevent the player from sleeping. This has the
     * same effect as canceling the event via {@link #setCancelled(boolean)}.
     * <br>
     * {@link me.itzloghotxd.hotbucket.event.Event.Result#DEFAULT} will result in the outcome described by
     * {@link #getBedEnterResult()}.
     *
     ...
     * {@link me.itzloghotxd.hotbucket.event.Event.Result#DENY}.
     * <p>
     * For backwards compatibility reasons this also returns true if
     * {@link #useBed()} is {@link me.itzloghotxd.hotbucket.event.Event.Result#DEFAULT} and the
