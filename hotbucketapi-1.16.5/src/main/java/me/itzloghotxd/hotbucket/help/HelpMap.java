...
public interface HelpMap {
     ...
     * me.itzloghotxd.hotbucket.command.PluginCommand} who's executor derives from {@code
     * commandClass} base class.
     *
     * @param commandClass The class for which the custom HelpTopicFactory
     *     applies. Must derive from either {@link me.itzloghotxd.hotbucket.command.Command}
     *     or {@link me.itzloghotxd.hotbucket.command.CommandExecutor}.
     ...
     * {@link me.itzloghotxd.hotbucket.command.Command} instead of {@link
     * me.itzloghotxd.hotbucket.command.PluginCommand} will need to check this collection in
