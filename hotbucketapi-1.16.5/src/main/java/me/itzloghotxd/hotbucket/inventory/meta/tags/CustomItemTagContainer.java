 ...
 * {@link me.itzloghotxd.hotbucket.persistence.PersistentDataHolder} API. Please use
 * {@link me.itzloghotxd.hotbucket.persistence.PersistentDataHolder} instead of this.
 */
@Deprecated
public interface CustomItemTagContainer {
     ...
     * should be done using {@link #removeCustomTag(me.itzloghotxd.hotbucket.NamespacedKey)}
