...
import me.itzloghotxd.hotbucket.command.CommandExecutor;
import me.itzloghotxd.hotbucket.command.CommandSender;
import me.itzloghotxd.hotbucket.command.PluginCommand;
import me.itzloghotxd.hotbucket.command.TabCompleter;
...
import me.itzloghotxd.hotbucket.plugin.java.JavaPlugin;
...
public final class PluginDescriptionFile {
     ...
     *     itself.
     * <li>If your namespace is <code>me.itzloghotxd.hotbucket.plugin</code>, and your class
     *     file is called <code>MyPlugin</code> then this must be
     *     <code>me.itzloghotxd.hotbucket.plugin.MyPlugin</code>
     * <li>No plugin can use <code>me.itzloghotxd.hotbucket.</code> as a base package for
     ...
     * <p>
     * Example:
     * <blockquote><pre>main: me.itzloghotxd.hotbucket.plugin.MyPlugin</pre></blockquote>
     *
    ...
    private void loadMap(@NotNull Map<?, ?> map) throws InvalidDescriptionException {
        ...
        try {
            ...
            if (main.startsWith("me.itzloghotxd.hotbucket.")) {
                throw new InvalidDescriptionException("main may not be within the me.itzloghotxd.hotbucket namespace");
            }
        } catch (NullPointerException ex) {
